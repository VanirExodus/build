...
""" % bcb_dev)
  ...
  script.UnpackPackageDir("install", "/tmp")
  script.SetPermissions("/tmp/backuptool.sh", 0, 0, 0755, None, None)
  script.SetPermissions("/tmp/backuptool.functions", 0, 0, 0755, None, None)
